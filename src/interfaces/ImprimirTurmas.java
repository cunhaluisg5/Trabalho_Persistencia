 ...
 * @author Luis
 */
public class ImprimirTurmas extends javax.swing.JDialog {

    /** Creates new form ImprimirTurmas */
    public ImprimirTurmas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(682, 342));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImprimirTurmas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ImprimirTurmas dialog = new ImprimirTurmas(new javax.swing.JFrame(), true);
